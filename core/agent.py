...
Respond with ONLY the <name> of the skill (e.g., "yt-dlp-expert") or "NO_MATCH"."""
        ...
        for endpoint in endpoints:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    elif 'message' in data: return data['message']['content'].strip()
...
def handle_remote_fallback(manager: SkillManager, query: str):
    ...
    choice = input("\n📥 Install and run one of these? (Enter number or 0 to cancel): ").strip()
    try:
        idx = int(choice)
