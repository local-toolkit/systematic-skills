...
> 使用news-aggregator skill 扫一下 CNN, Fox News 和 NY Post 的头条新闻。

**10. ☕️ 早安·全球 AI 速递 (Tech & AI)**

> 使用news-aggregator skill 帮我深度扫描 Hacker News 和 Product Hunt，看看过去 24 小时有哪些 **AI 和 LLM** 相关的重磅技术或新产品？

**11. 🇨🇳 中国科技圈早报 (China Tech)**

> 使用news-aggregator skill 看看 36氪 和 腾讯新闻，今天国内科技圈和互联网有什么大新闻？挑 5 个最重要的给我深度总结一下。

**12. 👨‍💻 极客与开源 (Dev & Open Source)**

> 使用news-aggregator skill GitHub 和 V2EX 上最近现在的热门项目 and 话题是什么？有没有什么好玩的开源工具？
